...
{
	private static int numPlayers = 0; //default
	...
	public void initPlayers()
	{
		...
		for (int i =0; i < numPlayers; i++)
		{
			...
			System.out.println(playersPlaying[i]);
		}
	...
	{
		createRobotTurtles();
		System.out.println(listOfTurtles);
		createRobotJewels();
		createCardDeck();
	...
	{
		System.out.println("starting createRobotJewels");
		if (numPlayers >= 1)
		{
