...
public class Crate extends Tile
{
	...
	public void findAndSetMovableDirections()
	{
		if (this.getNTile()!=null)
		{
			...
			if (!this.getNTile().getTileType().contentEquals("Normal") || this.getNTile().getOccupied() == true)
			{
		...
		{
			if (!this.getSTile().getTileType().contentEquals("Normal")  || this.getSTile().getOccupied() == true)
			{
		...
		{
			if (!this.getETile().getTileType().contentEquals("Normal") || this.getETile().getOccupied() == true)
			{
